...
public class TipoContactoDAOImpl implements TipoContactoDAO {
	...
	private static final String update = "UPDATE tiposDeContactos SET nombre = ? WHERE nombre = ?";
	...
	public List<TipoContactoDTO> readAll() {
		...
		try {
			...
			while (resultSet.next()) {
				TipoContactoDTO tipoContacto = new TipoContactoDTO(resultSet.getString("nombre"));
